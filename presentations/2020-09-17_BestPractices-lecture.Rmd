...
author: "Barbara Vreede, Utrecht University Library"
output:
...
--
.footnote[*) both of these are, first of all, you ;-)]
...
- Use functions to make your code more flexible, robust, and reusable.
- Documentation is an integral part of your project
- A good workflow supports you and makes your project more reproducible
